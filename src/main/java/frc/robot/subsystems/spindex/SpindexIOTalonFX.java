...
public class SpindexIOTalonFX implements SpindexIO {
    ...
    public SpindexIOTalonFX() {
        PhoenixUtil.applyMotorConfigs(spindexMotor, SpindexConstants.motorConfigs,  SpindexConstants.flashConfigRetries);

        BaseStatusSignal.setUpdateFrequencyForAll(SpindexConstants.updateFrequency,
                spindexMotorVoltage, spindexMotorVelocity, spindexMotorStatorCurrent, spindexMotorSupplyCurrent, spindexMotorTemperature);
        spindexMotor.optimizeBusUtilization();
    }

    @Override
    public void updateInputs(SpindexIOInputs inputs) {
        BaseStatusSignal.refreshAll(spindexMotorVoltage, spindexMotorVelocity, spindexMotorStatorCurrent, spindexMotorSupplyCurrent, spindexMotorTemperature);
