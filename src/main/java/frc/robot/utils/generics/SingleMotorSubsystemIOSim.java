...
public class SingleMotorSubsystemIOSim<T extends SingleMotorConstants> extends SingleMotorSubsystemIOTalonFX<T> {
    ...
    public SingleMotorSubsystemIOSim() {
        ...
        this.motorModel = (T.kUseFOC ? DCMotor.getKrakenX60Foc(1) : DCMotor.getKrakenX60(1))
    ...
    public void updateInputs(SingleMotorSubsystemInputs inputs) {
        ...
        double rps = motorModel.getSpeed(
